...
export function addDefaultHeaders(response: Response) {
  ...
  response.headers.set(
    ...
    `default-src 'none'; script-src 'self' 'unsafe-eval' ajax.cloudflare.com static.cloudflareinsights.com mc.yandex.ru; style-src 'self'; img-src 'self' data: mc.yandex.ru; connect-src 'self' mc.yandex.ru; child-src blob: mc.yandex.ru; frame-src blob: mc.yandex.ru; font-src 'self' data:;`,
  );
